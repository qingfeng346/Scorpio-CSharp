...
namespace Scorpio
{
    ...
    public class ScriptString : ScriptObject
    {
        ...
        public override ScriptObject Assign() { return Script.CreateString(m_Value); }
        public override ScriptObject GetValue(object index) {
            ...
            return Script.CreateString(m_Value[Util.ToInt32(index)].ToString());
        }
        ...
        public override ScriptObject Clone() {
            return Script.CreateString(m_Value);
        }
