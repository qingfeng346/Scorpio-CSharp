    ...
    public partial class ScriptParser {
        ...
        void PushObject(CodeObject obj, bool isAwait) {
            switch (obj) {
                ...
                case CodeArray array: {
                    if (array.Elements.Count > 100)
                        throw new ParserException(this, $"一次性申请Array变量不能超过100个,可是使用add或+代替:{array.Elements.Count}", PeekToken());
        ...
        CodeObject GetOneObject() {
            ...
            switch (token.Type) {
                ...
                case TokenType.Await: {
                    ret = new CodeAwait(token.SourceLine) { codeObject = GetObject() };
                    break;
                }
                default:
