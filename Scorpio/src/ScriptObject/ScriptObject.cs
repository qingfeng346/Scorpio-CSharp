...
namespace Scorpio {
    ...
    public abstract class ScriptObject : IPool {
        ...
        //获取变量
        public virtual ScriptValue GetValueByIndex(int key) { throw new ExecutionException($"Object类型[{ValueTypeName}]不支持获取变量 Index : {key}"); }
        public virtual ScriptValue GetValue(string key) { throw new ExecutionException($"Object类型[{ValueTypeName}]不支持获取变量 String : {key}"); }
        public virtual ScriptValue GetValue(double key) { throw new ExecutionException($"Object类型[{ValueTypeName}]不支持获取变量 Double : {key}"); }
        public virtual ScriptValue GetValue(long key) { throw new ExecutionException($"Object类型[{ValueTypeName}]不支持获取变量 Long : {key}"); }
        public virtual ScriptValue GetValue(object key) { throw new ExecutionException($"Object类型[{ValueTypeName}]不支持获取变量 Object : {key}"); }
        ...
        public virtual bool Equals(ScriptValue obj) { return obj.valueType == ScriptValue.scriptValueType && obj.index == Index; }
        public bool EqualReference(ScriptValue obj) { return obj.valueType == ScriptValue.scriptValueType && obj.index == Index; }
