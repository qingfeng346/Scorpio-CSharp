...
namespace Scorpio.Userdata {
    ...
    public class ScriptUserdataEnumType : ScriptUserdata {
        private ScorpioStringDictionary<ScriptValue> m_Enums;           //所有枚举的值
        public ScriptUserdataEnumType(Type value) {
            this.m_Value = value;
            this.m_ValueType = value;
            var names = Enum.GetNames(value);
            m_Enums = new ScorpioStringDictionary<ScriptValue>(names.Length);
        ...
        public override string ToString() => m_ValueType.Name;
