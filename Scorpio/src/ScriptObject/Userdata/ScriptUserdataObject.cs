...
namespace Scorpio.Userdata {
    ...
    public class ScriptUserdataObject : ScriptUserdata {
        ...
        public override ScriptValue GetValue(object index) {
            ...
            CommonParameters[0] = ScriptValue.CreateValue(index);
            return ScriptValue.CreateValue(func.Call(false, m_Value, CommonParameters, 1));
        }
        public override void SetValue(object index, ScriptValue value) {
            ...
            CommonParameters[0] = ScriptValue.CreateValue(index);
            CommonParameters[1] = value;
            func.Call(false, m_Value, CommonParameters, 2);
        }
        ...
        public override ScriptValue Plus(ScriptValue obj) {
            ...
            CommonParameters[0] = ThisValue;
            CommonParameters[1] = obj;
            return ScriptValue.CreateValue(func.Call(true, null, CommonParameters, 2));
        }
