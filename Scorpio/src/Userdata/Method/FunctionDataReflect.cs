...
namespace Scorpio.Userdata {
    ...
    public abstract class FunctionDataReflect : FunctionData {
        ...
        public FunctionDataReflect(MethodInfo method, Type[] parameterType, object[] defaultParameter, int requiredNumber, Type paramType) :
    ...
    public class FunctionDataReflectMethod : FunctionDataReflect {
        public FunctionDataReflectMethod(MethodInfo method, Type[] parameterType, object[] defaultParameter, int requiredNumber, Type paramType) :
            base(method, parameterType, defaultParameter, requiredNumber, paramType) {
        }
    ...
    public class FunctionDataReflectExtension : FunctionDataReflect {
        ...
        public FunctionDataReflectExtension(MethodInfo method, Type[] parameterType, object[] defaultParameter, int requiredNumber, Type paramType) :
            base(method, parameterType, defaultParameter, requiredNumber, paramType) {
